...
Revision ID: edfa8f4db2db
Revises: 
Create Date: 2019-12-16 19:42:21.042773
...
def upgrade():
    ...
    sa.Column('user_type', sa.Enum('admin', 'client', 'employee', name='typeenum'), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
